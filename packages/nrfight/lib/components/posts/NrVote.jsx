...
import { replaceComponent, Components, getRawComponent } from 'meteor/nova:core';
import { hasUpvoted } from 'meteor/nova:voting';
import { FormattedMessage } from 'react-intl';

class NrVote extends getRawComponent('Vote') {
  ...
  render() {
    ...
    const tooltip = (
      <Tooltip id="like-tooltip"><FormattedMessage id="posts.add_to_likes"/></Tooltip>
    );
